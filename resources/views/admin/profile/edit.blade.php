                                ...
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        ...
                                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                            @if (Auth::user()->image)
                                                <img src="{{ $url }}" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                                            @else
                                                <p class="mt-2 me-5">Chọn ảnh đại diện</p>
                                            @endif
                                        ...
                                        <p class="text-muted mb-0">INTERN BACKEND PHP</p>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 d-flex">
                                        ...
                                        <input type="text" class="form-control" id="websiteInput" placeholder="www.example.com" value="{{ asset("/") }}">
                                    </div>
                                    <div class="mb-3 d-flex">
                                        <div class="avatar-xs d-block flex-shrink-0 me-3">
                                        ...
                                        <input type="text" class="form-control" id="dribbleName" placeholder="Username" value="{{ asset("/") }}">
                                    </div>
                                    <div class="d-flex">
                                        <div class="avatar-xs d-block flex-shrink-0 me-3">
                                        ...
                                        <input type="text" class="form-control" id="pinterestName" placeholder="Username" value="{{ Auth::user()->name }}">
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" data-provider="flatpickr" id="JoiningdatInput" data-date-format="d M, Y" data-deafult-date="24 Nov, 2021" value="{{ Auth::user()->created_at }}" disabled placeholder="Select date">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="websiteInput1" placeholder="www.example.com" value="{{ asset("/") }}">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="address" id="cityInput" placeholder="City" value="{{ Auth::user()->address }}">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="countryInput" placeholder="Country" value="Việt Nam">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" minlength="5" maxlength="6" id="zipcodeInput" placeholder="Enter zipcode" value="100">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-12">
                                                        <div class="mb-3 pb-2">
                                                            ...
                                                            <textarea name="description" class="form-control" id="exampleFormControlTextarea" placeholder="Enter your description" rows="3" >{{ Auth::user()->description }}</textarea>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea class="form-control" id="jobDescription" name="description" rows="3" placeholder="Enter description">{{ Auth::user()->description }}</textarea>
                                                                </div>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="hstack gap-2 justify-content-end">
