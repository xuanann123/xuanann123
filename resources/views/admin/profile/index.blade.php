                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="swiper project-swiper mt-n4 swiper-initialized swiper-horizontal swiper-backface-hidden">
                                                            <div class="d-flex justify-content-end gap-2 mb-2">
                                                                <div class="slider-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-d610b86b10f94f3b1c" aria-disabled="true">
                                                                    <div class="avatar-title fs-18 rounded px-1">
                                                                        <i class="ri-arrow-left-s-line"></i>
                                                                    </div>
                                                                </div>
                                                                <div class="slider-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-d610b86b10f94f3b1c" aria-disabled="false">
                                                                    <div class="avatar-title fs-18 rounded px-1">
                                                                        <i class="ri-arrow-right-s-line"></i>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="swiper-wrapper" id="swiper-wrapper-d610b86b10f94f3b1c" aria-live="polite" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                                                                <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 5" style="width: 276px; margin-right: 25px;">
                                                                ...
                                                                <!-- end slide item -->
                                                                <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 5" style="width: 276px; margin-right: 25px;">
                                                                ...
                                                                <div class="swiper-slide" role="group" aria-label="3 / 5" style="width: 276px; margin-right: 25px;">
                                                                ...
                                                                <div class="swiper-slide" role="group" aria-label="4 / 5" style="width: 276px; margin-right: 25px;">
                                                                    <div class="card profile-project-card shadow-none profile-project-danger mb-0">
                                                                        <div class="card-body p-4">
                                                                            <div class="d-flex">
                                                                                <div class="flex-grow-1 text-muted overflow-hidden">
                                                                ...
                                                                <!-- end slide item -->
                                                                <div class="swiper-slide" role="group" aria-label="5 / 5" style="width: 276px; margin-right: 25px;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="acitivity-timeline">
                                                    <div class="acitivity-item d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{asset("theme/admin/assets/images/users/avatar-1.jpg")}}" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{asset("theme/admin/assets/images/users/avatar-6.jpg")}}" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{asset("theme/admin/assets/images/users/avatar-7.jpg")}}" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="acitivity-item d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{asset("theme/admin/assets/images/users/avatar-8.jpg")}}" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
