            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <form action="{{ route('admin.products.catalogues.store') }}" enctype="multipart/form-data"
                            method="post">
                            @csrf
                            <div class="row gy-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="mt-5">
                                        <div>
                                            <label for="formFile" class="form-label text-uppercase">Chọn ảnh danh mục sản
                                                phẩm</label>
