            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="{{ asset('themeadmin/assets/images/logo-dark.png') }}" alt=""
                                height="17">
                        </span>
                    </a>
                    ...
                    <a href="index.html" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{ asset('themeadmin/assets/images/logo-sm.png') }}" alt=""
                                height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('themeadmin/assets/images/logo-light.png') }}" alt=""
                                height="17">
                        </span>
                    </a>
                </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        @endphp
                        <img style="height: 3.5rem!important;
    width: auto!important;" class="rounded-circle header-profile-user"
                                                        src="{{ $url }}"
                                                        alt="Header Avatar">    
                        @else
                            

                        <img  style="width: auto!important;" class="rounded-circle header-profile-user"
                                                        src="{{ asset("theme/admin/assets/images/trend-avatar-1.jpg") }}"
                                                        alt="Header Avatar">
